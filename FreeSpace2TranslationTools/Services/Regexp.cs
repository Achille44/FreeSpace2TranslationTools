...
namespace FreeSpace2TranslationTools.Services
{
	public static partial class Regexp
    {
        ...
        [GeneratedRegex("(\\( (?:add-nav-waypoint|add-nav-ship|del-nav|hide-nav|restrict-nav|unhide-nav|unrestrict-nav|set-nav-visited|unset-nav-visited|select-nav|unselect-nav|is-nav-visited|lua-mark-ship|lua-mark-wing|ship-create|lua-staged-countdown-start|set-cargo|ship-change-alt-name).*?\")(.*?)(\".*?\\))", RegexOptions.Singleline)]
